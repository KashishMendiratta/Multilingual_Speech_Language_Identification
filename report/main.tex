...
\begin{figure}[t]
\centering
\includegraphics[width=0.48\columnwidth]{figures/language_sample.png}
\includegraphics[width=0.48\columnwidth]{figures/language_speakers.png}
...
\begin{figure}[t]
\centering
\includegraphics[width=0.8\columnwidth]{figures/tsne.png}
...
\section{Conclusion}
In this project we investigated spoken language identification using pretrained speech
transformers in a challenging low-resource setting. Our baseline-style MMS run achieved
27.7\% validation accuracy, which is significantly higher than random chance but still limited
by the dataset constraints. Generic augmentation reached 30.85\% validation and 31.58\% test
accuracy, while targeted selective augmentation produced the best observed top-1 accuracy of
43.4\%. Performance nevertheless varied substantially across languages and speakers.
