...
def preprocess_augmented(batch):
    waves = []
...
print("Preparing original train set...")
train_encoded_clean = train_ds.map(
    preprocess_clean,
    batched=True,
    remove_columns=train_ds.column_names,
)

print("Preparing augmented train set...")
train_encoded_aug = train_ds.map(
    preprocess_augmented,
    batched=True,
    remove_columns=train_ds.column_names,
)

train_encoded = concatenate_datasets([train_encoded_clean, train_encoded_aug]).shuffle(seed=42)
...
print("Original train size:", len(train_encoded_clean))
print("Augmented train size:", len(train_encoded_aug))
print("Final train size:", len(train_encoded))
print("Validation size:", len(valid_encoded))
